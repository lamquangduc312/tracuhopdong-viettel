...
// Insert into mobile_postpaid array
const findStr = 'pdfTitle: "PHIẾU YÊU CẦU THAY ĐỔI DỊCH VỤ VIỄN THÔNG DI ĐỘNG MẶT ĐẤT HÌNH THỨC THANH TOÁN TRẢ SAU (BM01.TĐTS.CN)"\n                }';
const insertPoint = html.indexOf(findStr);
if (insertPoint > -1) {
    html = html.substring(0, insertPoint + findStr.length) + newDocs + html.substring(insertPoint + findStr.length);
