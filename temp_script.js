const lucide = {createIcons: ()=>{}}; const document = {getElementById: ()=>({classList:{add:()=>{}, remove:()=>{}, replace:()=>{}}})}; const alert = ()=>{};
...
{ value: "dau_noi_moi", label: "Đấu nối mới" },
            ...
            ftth: [
                {
                    ...
                    code: "656190090/APP_VIETTEL/30082026",
                    date: "15/10/2022",
        ...
        function switchAccountTab(tab) {
            const tabs = ['mobile', 'internet', 'tv', 'tv360', 'camera', 'mysign', 'vcontract', 'vpost'];
            tabs.forEach(t => {
